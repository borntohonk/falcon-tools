...
#define  TSEC_DMARTFCMD_WRITE      (1 << 5)
...
#define TSEC_FALCON_IMEMC   0x1180
#define TSEC_FALCON_IMEMD   0x1184
...
#define TSEC_SCP_STAT0 0x1450
#define TSEC_SCP_STAT1 0x1454
#define TSEC_SCP_STAT2 0x1458
#define TSEC_SCP_SEC_ERR 0x1494
